...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder>{
    ...
    private ArrayList product_id, product_title, product_price, product_stock, product_code;
    Activity activity;

    CustomAdapter(Activity activity, Context context, ArrayList product_id,ArrayList product_title,ArrayList product_price,ArrayList product_stock, ArrayList product_code){
